...
Activa tu plan para ver estadísticas reales del bot.",
    ...
    by_plan_7 = by_plan_30 = None
    act_by_plan_7 = act_by_plan_30 = None
    by_score_30 = None
    ...
    if callable(get_last_days_stats_by_plan):
        by_plan_7 = get_last_days_stats_by_plan(7)
    ...
    if callable(get_signal_activity_stats_by_plan):
        act_by_plan_7 = get_signal_activity_stats_by_plan(7)
...
"
    ...
    def _fmt_plan_block(title: str, s: dict, a: dict | None = None) -> str:
        ...
        if a:
            lines.append(f"• Señales scanner: {a.get('signals_total', 0)} | Score prom: {a.get('avg_score', '—')}")
...
"]
    ...
    if by_plan_30:
        ...
        parts.append("📊 **Rendimiento por plan (7D)**")
        parts.append(_fmt_plan_block("🟢 FREE", (by_plan_7 or {}).get("free", {}), (act_by_plan_7 or {}).get("free")))
        parts.append("")
        parts.append(_fmt_plan_block("🟡 PLUS", (by_plan_7 or {}).get("plus", {}), (act_by_plan_7 or {}).get("plus")))
        parts.append("")
        parts.append(_fmt_plan_block("🔴 PREMIUM", (by_plan_7 or {}).get("premium", {}), (act_by_plan_7 or {}).get("premium")))

    if act7 or act30:
        parts.append("
📈 **Actividad general del scanner**")
        if act7:
