...
ADX_PERIOD = 14
ADX_MIN_TREND_1H = 20
ADX_MIN_TREND_15M = 18
ADX_MIN_SETUP_5M = 16

BB_PERIOD = 20
BB_STD = 2.0

VOLUME_MULTIPLIER_BREAKOUT = 1.35
VOLUME_MULTIPLIER_PULLBACK = 1.05

MIN_BB_WIDTH_5M = 0.0055
MIN_BB_WIDTH_15M = 0.0075

MIN_DISTANCE_EMA_1H = 0.0020
MIN_DISTANCE_EMA_15M = 0.0012

MIN_CANDLE_BODY_RATIO = 0.30
MAX_WICK_RATIO_BREAKOUT = 0.45
...
def mtf_strategy(
    ...
    if df_1h.iloc[-1]["adx"] >= 28:
        score += 5
        components.append(("adx_bonus_1h", 5))

    if last_5m["volume"] >= last_5m["vol_ma"] * 1.6:
        score += 5
