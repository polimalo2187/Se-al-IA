...
def _calculate_stats(from_date: datetime) -> Dict:
    ...
    # Evaluar señales expiradas antes de calcular estadísticas
    ...
    winrate = (
        round((won / effective_trades) * 100, 2)
...
def get_signal_activity_stats(days: int):
...
def get_signal_activity_stats_by_plan(days: int):
...
def get_winrate_by_score(days: int, buckets=None):
    ...
    results = list(_results_cursor(from_date))
